...
const faqs = [
  ...
  { q: "What's your pricing model?", a: "We offer transparent, flat-rate monthly retainers based on your transaction volume and complexity. No hidden hourly fees." },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        >
          <Accordion type="single" collapsible className="w-full">
            {faqs.map((faq, idx) => (
              <AccordionItem key={idx} value={`item-${idx}`} className="border-b border-primary/20 last:border-0">
                <AccordionTrigger className="text-left text-white hover:text-primary transition-colors py-4 font-medium text-lg">
                  {faq.q}
                </AccordionTrigger>
